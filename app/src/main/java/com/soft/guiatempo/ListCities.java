...
public class ListCities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CityListRecyclerView adapter = new CityListRecyclerView(this, cityViewModel);
        ...
        recyclerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                System.out.println("ListCitiess !!");
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ListCities.this, RegisterCity.class);
